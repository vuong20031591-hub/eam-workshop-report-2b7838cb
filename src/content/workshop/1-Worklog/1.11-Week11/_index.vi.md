...
| --- | --- | --- | --- | --- |
| 1 | Tạo **Launch Template** `upscale-gpu-lt` (g5.xlarge, IAM role, user-data pull ECR + `docker run`). | 16/07/2026 | 16/07/2026 | - |
| 2 | Tạo **Auto Scaling Group** min=1 max=3, scaling policy target `Upscale/GPU/Utilization = 70%`. | 17/07/2026 | 17/07/2026 | [EC2 Auto Scaling](https://docs.aws.amazon.com/autoscaling/ec2/userguide/) |
...
| 5 | Tạo **SQS** standard queue `upscale-ai-jobs`, visibility timeout 300s; BE consume qua polling loop (feature flag OFF cho MVP). | 21/07/2026 | 22/07/2026 | [SQS](https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/) |
