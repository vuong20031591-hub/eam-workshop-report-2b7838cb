...
| --- | --- | --- | --- | --- |
| 1 | Create **Launch Template** `upscale-gpu-lt` (g4dn.xlarge, ECS-optimized GPU AMI, IAM role with `AmazonEC2ContainerServiceforEC2Role`). | 16/07/2026 | 16/07/2026 | [ECS-optimized AMI](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html) |
...
| 5 | Point the **ALB target group** `upscale-api-tg` at the ECS service (dynamic host-port mapping); create **SQS** standard queue `upscale-job-queue`, visibility timeout 300s; BE consumes via a polling loop (feature flag OFF for MVP). | 21/07/2026 | 22/07/2026 | [SQS](https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/) |
