...
Package BE as a multi-stage Docker image on `nvidia/cuda:12.4-runtime`, push to Amazon ECR private repo `upscale-be`. And swap the upload pattern to presigned POST so FE writes files directly to S3 instead of proxying through BE.
...
| 2 | Create **ECR** repo `upscale-be`, enable scan-on-push + immutable tags. | 11/06/2026 | 11/06/2026 | [Amazon ECR](https://docs.aws.amazon.com/AmazonECR/latest/userguide/) |
