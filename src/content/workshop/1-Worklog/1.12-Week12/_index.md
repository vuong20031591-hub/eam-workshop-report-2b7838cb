...
| 3 | Tag every resource `Project=Upscaler, Env=prod` so Cost Explorer can filter. | 26/07/2026 | 26/07/2026 | [AWS Tagging](https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html) |
