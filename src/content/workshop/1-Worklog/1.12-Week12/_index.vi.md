...
- Hoàn thiện tài liệu dự án và tổng kết kết quả 12 tuần thực tập.
...
| T6 | Rà soát hệ thống lần cuối trên các môi trường và tổng kết kết quả 12 tuần thực tập cùng team. | 10/07/2026 | 10/07/2026 | Tài liệu dự án |

### Kết quả đạt được Tuần 12

- Hoàn tất kiểm thử chức năng trên tất cả module, các bug quan trọng đều đã đóng trước khi kết thúc dự án.
...
- Bản tổng kết 12 tuần được chốt cùng team, ghi lại kết quả và các mục còn mở để phục vụ workshop và phần tự đánh giá.

### Khó khăn & Bài học

- **Khó khăn:**
  - Tuần cuối phải cân đối giữa fix bug, tối ưu hiệu năng và hoàn thiện tài liệu để khép lại dự án.
- **Giải pháp:**
  - Ưu tiên các vấn đề ảnh hưởng lớn tới độ ổn định, gom các fix nhỏ vào một PR và viết tài liệu song song với việc test.
- **Bài học:**
  - Test, tối ưu và tài liệu nếu làm đều tay xuyên suốt dự án sẽ giảm áp lực dồn vào tuần cuối; càng gần đích, giữ ổn định quan trọng hơn thêm tính năng.
